...
const reasons = [
  {
    ...
    description: "Systems designed by educators to support pedagogy-first learning workflows.",
  ...
  },
  {
    ...
    description: "Automate boring paperwork and focus 100% on student development.",
  ...
  },
  {
    ...
    description: "Centralized management for multiple schools or institutes from a single dashboard.",
  ...
  },
  {
    ...
    description: "Comprehensive training for teachers and staff to ensure smooth adoption.",
